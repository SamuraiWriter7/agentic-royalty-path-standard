...
Any commerce action, payment record, authorization event, or royalty candidate should be treated as provisional until reviewed by a human, marketplace rule, legal framework, or external royalty engine.
...
* Mapping model for external provider events into Agentic Royalty Path records
...
* Candidate royalty share mapping based on evidence references
...
Any `suggested_share`, `royalty_candidate`, or payment-aware attribution should be treated as provisional until reviewed by a human, marketplace rule, legal framework, or external royalty engine.
...
Any `royalty_mapping`, payment-related record, or value attribution should be treated as a candidate until reviewed by a human, marketplace rule, legal framework, or external royalty engine.
...
It introduces a path-centered model for connecting AI agent goals, action sequences, evidence records, execution logs, audit states, and royalty candidate mappings.
...
v0.1 does not define legal royalty claims.

Instead, it provides an audit-ready record format for identifying value-generation paths and connecting them to possible royalty candidates.

The `royalty_mapping` field should be treated as a candidate mapping until reviewed by a human, marketplace rule, legal framework, or external royalty engine.
